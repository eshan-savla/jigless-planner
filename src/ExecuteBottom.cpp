  ...
  ExecuteBottom::on_activate(const rclcpp_lifecycle::State & previous_state)
{
  ...
  send_goal_options.feedback_callback = std::bind(&ExecuteBottom::feedbackCallback, this, std::placeholders::_1, std::placeholders::_2);
  send_goal_options.result_callback = std::bind(&ExecuteBottom::resultCallback, this, std::placeholders::_1);
